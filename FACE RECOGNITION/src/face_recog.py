...
def get_project_root():
    #Return the Face Recognition system root directory.
...
class PersonalIdentifierApp:
    ...
    def __init__(self, window):
        ...
        self.haarcasecade_path = os.path.join(self.project_root, "haarcascade_frontalface_default.xml")
        self.trainimagelabel_path = os.path.join(self.project_root, "TrainingData", "trainer.yml")
        self.trainimage_path = os.path.join(self.project_root, "TrainingData", "Images")
        self.persondetail_path = os.path.join(self.project_root, "TrainingData", "person_details.csv")
        self.attendance_path = os.path.join(self.project_root, "TrainingData", "attendance.csv")
        ...
        try:
            ...
            while True:
                ...
                for (x, y, w, h) in faces:
                    ...
                    sample_num += 1
                    image_file = os.path.join(path, f"{details['Name']}_{details['ID']}_{sample_num}.jpg")
                    cv2.imwrite(image_file, gray[y:y+h, x:x+w])
